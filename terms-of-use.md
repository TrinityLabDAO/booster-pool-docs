...
Welcome to [https://boosterpool.xyz/](https://boosterpool.xyz/), a website-hosted user interface (the "Interface" or "App") provided by Trinity Lab ("we", "our", or "us"). The Interface provides access to liquidity pools on decentralized exchange Uniswap v3.\
...
8.  **Dispute Resolution**
    ...
    We will use our best efforts to resolve any potential disputes through informal, good faith negotiations. If a potential dispute arises, you must contact us by sending an email to [legal@uniswap.org](mailto:legal@uniswap.org) so that we can attempt to resolve it without resorting to formal dispute resolution. If we aren't able to reach an informal resolution within sixty days of your email, then you and we both agree to resolve the potential dispute according to the process set forth below.
